...
public class DeltaAlternativeBean implements Bean<DeltaAlternative>, Prioritized {
    ...
    public Set<Type> getTypes() {
        ...
        types.add(Alternatives.class);
        types.add(DeltaAlternative.class);
    ...
    public void destroy(DeltaAlternative instance, CreationalContext<DeltaAlternative> creationalContext) {
