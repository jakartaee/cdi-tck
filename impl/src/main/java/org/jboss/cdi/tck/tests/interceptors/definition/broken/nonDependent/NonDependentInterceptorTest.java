...
public class NonDependentInterceptorTest extends AbstractTest {

    @Deployment
    @ShouldThrowException(DefinitionException.class)
    public static WebArchive deploy() {
        return new WebArchiveBuilder().withTestClassPackage(NonDependentInterceptorTest.class).build();
    }

    @Test
    @SpecAssertion(section = ENABLED_INTERCEPTORS, id = "j")
