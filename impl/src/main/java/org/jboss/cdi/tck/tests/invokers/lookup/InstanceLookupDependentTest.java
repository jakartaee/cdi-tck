...
public class InstanceLookupDependentTest extends AbstractTest {
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClass(InstanceLookupDependentTest.class)
    ...
    @SpecAssertion(section = Sections.CONFIGURING_LOOKUPS, id = "bb")
    ...
    public void test(InvokerHolder invokers) throws Exception {
        ...
        assertEquals("foobar1", hello.invoke(null, null));
        assertEquals("foobar2", hello.invoke(null, null));
