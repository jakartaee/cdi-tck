...
public class DependentBeanCreator implements SyntheticBeanCreator<DependentBean> {
    @Override
    public DependentBean create(SyntheticInjections injections, Parameters params) {
