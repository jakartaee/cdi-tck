...
public class EJBObserverMethodNotBusinessMethodTest extends AbstractTest {
    ...
    @SpecAssertions({ @SpecAssertion(section = OBSERVER_METHODS, id = "d"), @SpecAssertion(section = OBSERVES, id = "g") })
