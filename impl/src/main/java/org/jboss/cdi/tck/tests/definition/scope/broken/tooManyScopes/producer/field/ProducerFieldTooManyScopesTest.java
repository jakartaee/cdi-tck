...
public class ProducerFieldTooManyScopesTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(ProducerFieldTooManyScopesTest.class)
                .withClass(ProducerFieldWithTooManyScopeTypes_Broken.class).build();
    }

    @Test
    @SpecAssertions({ @SpecAssertion(section = DECLARING_BEAN_SCOPE, id = "bc"),
