...
public class TooManyScopeTypesTest extends AbstractTest {
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = STEREOTYPE_DEFAULT_SCOPE, id = "ab"),
            @SpecAssertion(section = EXCEPTIONS, id = "b") })
