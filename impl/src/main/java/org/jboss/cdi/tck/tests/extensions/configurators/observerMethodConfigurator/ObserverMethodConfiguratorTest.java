...
public class ObserverMethodConfiguratorTest extends AbstractTest {
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = Sections.OBSERVER_METHOD_CONFIGURATOR, id = "ab"),
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = Sections.OBSERVER_METHOD_CONFIGURATOR, id = "ac"),
            @SpecAssertion(section = Sections.OBSERVER_METHOD_CONFIGURATOR, id = "bg"),
    ...
    @SpecAssertions({ @SpecAssertion(section = Sections.OBSERVER_METHOD_CONFIGURATOR, id = "aa"),
            @SpecAssertion(section = Sections.OBSERVER_METHOD_CONFIGURATOR, id = "be"),
