...
public class ParameterizedReturnTypeWithTypeVariableTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(ParameterizedReturnTypeWithTypeVariableTest.class)
                .withClasses(GeneralListProducer.class).build();
    }
