...
public class BusinessOperationEventInspector {
    ...
    public void observeBusinessOperationEventObservations(@Observes BusinessOperationObservedEvent event) {
        businessOperationObservations.incrementAndGet();
    }

    public int getBusinessOperationObservations() {
        return businessOperationObservations.get();
    }

    public void reset() {
        businessOperationObservations.set(0);
    }
