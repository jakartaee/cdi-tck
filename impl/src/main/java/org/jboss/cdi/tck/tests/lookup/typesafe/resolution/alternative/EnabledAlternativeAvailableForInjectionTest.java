...
public class EnabledAlternativeAvailableForInjectionTest extends AbstractTest {
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(EnabledAlternativeAvailableForInjectionTest.class).build();
    }
