...
public class RemoteBusinessDisposalMethodTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(RemoteBusinessDisposalMethodTest.class).build();
    }

    @Test(groups = { INTEGRATION, JAVAEE_FULL })
    @SpecAssertion(section = DISPOSER_METHOD_EE, id = "a")
    @SpecAssertion(section = DECLARING_DISPOSER_METHOD_EE, id = "a")
    public void disposalMethodOnSessionBeanCannotBeRemoteBusinessMethod() {
    }
}
