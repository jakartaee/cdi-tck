 ...
 * 2014-11-21T13:29:58.488+01:00
 * Generated source version: 3.0.1
 * 
 */
@WebServiceClient(name = "Translator", 
                  targetNamespace = "http://ws.injection.lookup.tests.tck.cdi.jboss.org/")
public class TranslatorService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.injection.lookup.tests.tck.cdi.jboss.org/", "Translator");
    public final static QName TranslatorEndpointPort = new QName("http://ws.injection.lookup.tests.tck.cdi.jboss.org/", "TranslatorEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("");
