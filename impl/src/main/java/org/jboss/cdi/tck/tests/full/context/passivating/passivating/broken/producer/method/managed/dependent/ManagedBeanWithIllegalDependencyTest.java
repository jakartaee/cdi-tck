 ...
 */
package org.jboss.cdi.tck.tests.full.context.passivating.passivating.broken.producer.method.managed.dependent;
...
public class ManagedBeanWithIllegalDependencyTest extends AbstractTest {

    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(ManagedBeanWithIllegalDependencyTest.class).build();
    }
