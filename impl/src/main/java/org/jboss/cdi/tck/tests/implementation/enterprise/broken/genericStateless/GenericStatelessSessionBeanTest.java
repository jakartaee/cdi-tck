...
public class GenericStatelessSessionBeanTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(GenericStatelessSessionBeanTest.class).build();
    }
