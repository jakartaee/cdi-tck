...
@WebServiceClient(name = "Translator", 
                  ...
                  targetNamespace = "http://ws.request.context.tests.tck.cdi.jboss.org/") 
public class TranslatorService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.request.context.tests.tck.cdi.jboss.org/", "Translator");
    public final static QName TranslatorEndpointPort = new QName("http://ws.request.context.tests.tck.cdi.jboss.org/", "TranslatorEndpointPort");
    static {
        URL url = null;
        try {
