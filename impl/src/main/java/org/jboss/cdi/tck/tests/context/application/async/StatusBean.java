...
public class StatusBean {
    ...
    public boolean isApplicationBeanAvailable() {
        return applicationBeanAvailable;
    }

    public void setApplicationBeanAvailable(boolean applicationBeanAvailable) {
        this.applicationBeanAvailable = applicationBeanAvailable;
    }
