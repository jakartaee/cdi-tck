...
public class WithAutoCloseCreator implements SyntheticBeanCreator<WithAutoClose> {
    @Override
    public WithAutoClose create(SyntheticInjections lookup, Parameters params) {
