...
public class TypeVariableReturnTypeTest extends AbstractTest {
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = PRODUCER_METHOD, id = "ib"),
            @SpecAssertion(section = LEGAL_BEAN_TYPES, id = "la") })
