...
public class RawInstanceFieldInjectionTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(RawInstanceFieldInjectionTest.class)
                .withClasses(Foo.class, FieldInjectionBar.class).build();
    }
