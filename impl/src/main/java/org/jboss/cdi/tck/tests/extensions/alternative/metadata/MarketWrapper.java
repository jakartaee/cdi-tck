...
public class MarketWrapper extends AnnotatedTypeWrapper<Market> {
    ...
    public AnnotatedMethodWrapper<? super Market> wrapMethodParameter(AnnotatedMethod<? super Market> delegate, boolean keepOriginalAnnotations) {
        ...
        AnnotatedMethodWrapper<Market> methodWrapper = new AnnotatedMethodWrapper(delegate, keepOriginalAnnotations);
        methodWrapper = methodWrapper.replaceParameters(new AnnotatedParameterWrapper<Market>(methodWrapper.getParameter(0), true) {
            @Override
    ...
    private AnnotatedConstructor<Market> wrapConstructor
        ...
        AnnotatedConstructorWrapper<Market> constructor = new AnnotatedConstructorWrapper(delegate, keepOriginalAnnotations, annotations);
        constructor.replaceParameters(new AnnotatedParameterWrapper(constructor.getParameter(0), keepOriginalAnnotations, annotations) {
            @Override
            public Type getBaseType() {
