...
public class VisibilityOfAnnotatedTypesFromExtensionInBravoBeanArchiveTest extends AbstractTest {

    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(VisibilityOfAnnotatedTypesFromExtensionInBravoBeanArchiveTest.class)
                .withBeanLibrary("alpha.jar", Soda.class)
                .withBeanLibrary("bravo.jar", Beer.class, AnnotatedTypeObserverExtension.class).build();
    }
