...
public class IndirectOverrideTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(IndirectOverrideTest.class).build();
    }

    @Test
    @SpecAssertion(section = SPECIALIZE_PRODUCER_METHOD, id = "ca")
