...
public class WebServiceReferenceInjectionTest extends AbstractTest {

    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClassPackage(WebServiceReferenceInjectionTest.class)
                .build();
    }

    @Test(groups = { JAX_WS, JAVAEE_FULL })
    @SpecAssertion(section = RESOURCE_LIFECYCLE, id = "le")
    public void testInjectionOfWebServiceReference() {
        ...
        Assert.assertNotNull(instance.getTranslator());
        Assert.assertEquals(instance.getTranslator().translate(), TranslatorEndpoint.MESSAGE);
    }
}
