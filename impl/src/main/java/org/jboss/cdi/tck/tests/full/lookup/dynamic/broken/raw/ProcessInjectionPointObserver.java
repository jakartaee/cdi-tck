...
import org.jboss.cdi.tck.tests.full.lookup.dynamic.broken.raw.Baz;
...
public class ProcessInjectionPointObserver implements Extension {
    ...
    public void observeProcessInjectionPoint(@Observes ProcessInjectionPoint<Baz, Instance> event, BeanManager beanManager) {
