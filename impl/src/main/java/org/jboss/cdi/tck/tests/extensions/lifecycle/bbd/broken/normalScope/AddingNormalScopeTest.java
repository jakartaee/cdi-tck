...
public class AddingNormalScopeTest extends AbstractTest {
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = BEFORE_BEAN_DISCOVERY, id = "ac"), @SpecAssertion(section = UNPROXYABLE, id = "baa") })
