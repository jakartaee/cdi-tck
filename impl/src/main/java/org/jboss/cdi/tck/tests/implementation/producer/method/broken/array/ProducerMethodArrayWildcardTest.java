...
public class ProducerMethodArrayWildcardTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(ProducerMethodArrayWildcardTest.class)
                .withClasses(ParameterizedTypeWithWildcardBrokenProducer.class).build();
    }
