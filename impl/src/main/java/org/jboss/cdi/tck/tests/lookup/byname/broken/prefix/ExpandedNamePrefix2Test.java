...
public class ExpandedNamePrefix2Test extends AbstractTest {

    @ShouldThrowException(DeploymentException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(ExpandedNamePrefix2Test.class).withClasses(FooBar.class, FooBarBaz.class).build();
    }
