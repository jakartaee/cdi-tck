...
import org.jboss.cdi.tck.tests.invokers.lookup.badargeq.MyDependency;
import org.jboss.cdi.tck.tests.invokers.lookup.badargeq.MyService;
import org.jboss.cdi.tck.tests.invokers.lookup.badargeq.TestExtension;
...
public class BadArgumentLookupEqualToNumberOfParamsTest extends AbstractTest {
    @Deployment
    @ShouldThrowException(DeploymentException.class)
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClass(BadArgumentLookupEqualToNumberOfParamsTest.class)
    ...
    @SpecAssertion(section = Sections.CONFIGURING_LOOKUPS, id = "ec")
    public void trigger() {
    }
