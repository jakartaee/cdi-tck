 ...
 */
package org.jboss.cdi.tck.interceptors.tests.lifecycleCallback.overriden;
...
public class OverridenLifecycleCallbackInterceptorTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(OverridenLifecycleCallbackInterceptorTest.class).build();
    }
