 ...
 * 2014-11-18T14:23:11.627+01:00
 * Generated source version: 3.0.1
 * 
 */
@WebServiceClient(name = "Translator", 
                  wsdlLocation = "WEB-INF/Translator.wsdl",
                  targetNamespace = "http://contextual.non.injection.lookup.tests.tck.cdi.jboss.org/") 
public class TranslatorService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://contextual.non.injection.lookup.tests.tck.cdi.jboss.org/", "Translator");
    public final static QName TranslatorEndpointPort = new QName("http://contextual.non.injection.lookup.tests.tck.cdi.jboss.org/", "TranslatorEndpointPort");
    static {
        URL url = null;
        try {
