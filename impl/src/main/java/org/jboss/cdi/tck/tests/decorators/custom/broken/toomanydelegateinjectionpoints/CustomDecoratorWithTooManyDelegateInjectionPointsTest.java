...
public class CustomDecoratorWithTooManyDelegateInjectionPointsTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(CustomDecoratorWithTooManyDelegateInjectionPointsTest.class)
