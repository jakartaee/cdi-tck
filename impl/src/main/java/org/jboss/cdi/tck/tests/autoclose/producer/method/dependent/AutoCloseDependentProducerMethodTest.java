 ...
 */
package org.jboss.cdi.tck.tests.autoclose.producer.method.dependent;
...
public class AutoCloseDependentProducerMethodTest extends AbstractTest {
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClassPackage(AutoCloseDependentProducerMethodTest.class)
                .build();
    }
