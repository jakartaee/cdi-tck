...
public class WithAnnotationsTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(WithAnnotationsTest.class)
    ...
    public void testDelivery() {
        ...
        assertEquals(processedDesiredTypes.size(), 4);
        ...
        assertTrue(processedDesiredTypes.contains(Hawk.class));
    }
