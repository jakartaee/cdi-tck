 ...
 */
package org.jboss.cdi.tck.tests.autoclose.producer.field.dependent;
...
public class AutoCloseDependentProducerFieldTest extends AbstractTest {
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClassPackage(AutoCloseDependentProducerFieldTest.class)
                .build();
    }
