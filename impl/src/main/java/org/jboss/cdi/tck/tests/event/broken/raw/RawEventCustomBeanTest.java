...
public class RawEventCustomBeanTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(RawEventCustomBeanTest.class)
                .withClasses(Bar.class, AfterBeanDiscoveryObserver.class, CustomBarBean.class, CustomEventInjectionPoint.class)
