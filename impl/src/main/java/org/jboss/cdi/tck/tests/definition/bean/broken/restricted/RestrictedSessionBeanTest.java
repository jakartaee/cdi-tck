...
public class RestrictedSessionBeanTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassDefinition(RestrictedSessionBeanTest.class)
                .withClasses(Animal.class, RockBean.class).build();
    }

    @Test(groups = INTEGRATION)
    @SpecAssertion(section = BEAN_TYPES_EE, id = "b")
