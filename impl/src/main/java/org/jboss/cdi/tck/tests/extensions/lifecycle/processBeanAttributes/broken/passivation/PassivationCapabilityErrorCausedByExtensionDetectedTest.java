...
public class PassivationCapabilityErrorCausedByExtensionDetectedTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(PassivationCapabilityErrorCausedByExtensionDetectedTest.class)
                .withClasses(ModifyingExtension1.class, Laptop.class).withExtension(ModifyingExtension1.class).build();
    }
