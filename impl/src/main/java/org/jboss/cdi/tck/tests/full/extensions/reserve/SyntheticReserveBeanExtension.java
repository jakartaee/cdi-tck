...
public class SyntheticReserveBeanExtension implements Extension {

    public void addBean(@Observes AfterBeanDiscovery event) {
        event.addBean()
                .addTypes(SyntheticReserveBean.class, TestBean.class)
                .reserve(true)
                .priority(1)
                .produceWith(objects -> new SyntheticReserveBean());
    }
}
