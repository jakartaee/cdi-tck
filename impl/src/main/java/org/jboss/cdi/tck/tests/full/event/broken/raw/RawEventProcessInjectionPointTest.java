...
public class RawEventProcessInjectionPointTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(RawEventProcessInjectionPointTest.class)
                .withBeansXml(new BeansXml(BeanDiscoveryMode.ALL))
                .withClasses(Baz.class, Foo.class, ProcessInjectionPointObserver.class, ForwardingInjectionPoint.class)
