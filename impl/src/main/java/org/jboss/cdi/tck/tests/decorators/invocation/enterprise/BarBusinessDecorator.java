 ...
 */
@Decorator
public abstract class BarBusinessDecorator implements Business {

    @Inject
    @Delegate
    private BarBusiness business;

    @Override
    public String businessOperation1() {
        CallStore.addCaller(BarBusinessDecorator.class.getSimpleName());
