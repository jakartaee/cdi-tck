...
public class ParameterizedTypesInjectionToParameterizedWithTypeVariableTest extends AbstractTest {

    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(ParameterizedTypesInjectionToParameterizedWithTypeVariableTest.class)
                .withClasses(Dao.class, ObjectDao.class, StringDao.class, ConsumerTypeVariable.class).build();
    }
