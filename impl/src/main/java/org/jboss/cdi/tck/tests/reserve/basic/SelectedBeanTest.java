...
public class SelectedBeanTest extends AbstractTest {
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClass(SelectedBeanTest.class)
    ...
    public void testSelectedBean() {
        assertEquals(getContextualReference(Foo.class).getId(), "Baz");
    }
}
