...
public class ArgumentLookupInstanceTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClass(ArgumentLookupInstanceTest.class)
    ...
    @SpecAssertion(section = Sections.CONFIGURING_LOOKUPS, id = "dc")
    ...
    static class MyService {
        public String hello(Instance<MyDependency> instance) {
            String beanClass = instance.getHandle().getBean().getBeanClass().getSimpleName();
            MyDependency dependency = instance.get();
            return "foobar" + dependency.getId() + "_" + beanClass;
        }
    }
