...
public class ModifyingProducerViaConfigureAndSetTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(ModifyingProducerViaConfigureAndSetTest.class)
                .withExtension(AddAndConfigureExtension.class)
                .withBeansXml(new BeansXml(BeanDiscoveryMode.ALL))
                .build();
    }

    @Test
    @SpecAssertion(section = PROCESS_PRODUCER, id = "gc")
