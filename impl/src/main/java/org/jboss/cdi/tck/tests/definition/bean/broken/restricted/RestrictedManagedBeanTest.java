...
public class RestrictedManagedBeanTest extends AbstractTest {

    @ShouldThrowException(DefinitionException.class)
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassDefinition(RestrictedManagedBeanTest.class)
                .withClasses(Animal.class, Stone.class).build();
    }

    @Test
    @SpecAssertions({ @SpecAssertion(section = RESTRICTING_BEAN_TYPES, id = "j"),
