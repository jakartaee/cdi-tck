...
public class InvalidInterceptionFactoryInjectionPointTest extends AbstractTest {

    @Deployment
    @ShouldThrowException(value = DefinitionException.class)
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClass(InvalidInterceptionFactoryInjectionPointTest.class)
                .withClasses(BeanWithInvalidInjectionPoint.class)
