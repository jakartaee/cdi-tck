...
public class ProducerOnDisabledReserveNotAvailableForInjectionTest extends AbstractTest {
    @Deployment
    @ShouldThrowException(DeploymentException.class)
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClassPackage(ProducerOnDisabledReserveNotAvailableForInjectionTest.class)
                .build();
    }
