 ...
 */
package org.jboss.cdi.tck.tests.full.context.passivating.passivating.broken.producer.method.managed;
...
public class NonPassivationCapableProducerMethodTest extends AbstractTest {
    ...
    @SpecAssertion(section = PASSIVATION_VALIDATION, id = "ca")
