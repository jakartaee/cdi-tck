...
public class SheepWSEndPointService extends Service {
    ...
    public SheepWS getSheepWSPort() {
        return super.getPort(new QName("http://ws.contextual.non.injection.lookup.tests.tck.jsr299.jboss.org/",
                "SheepWSEndPointPort"), SheepWS.class);
    }

    // @WebEndpoint(name = "SheepWSPort")
    public SheepWS getSheepWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.contextual.non.injection.lookup.tests.tck.jsr299.jboss.org/",
                "SheepWSEndPointPort"), SheepWS.class, features);
    }
}
