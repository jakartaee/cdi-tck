...
public class AutoCloseSyntheticBeanTest extends AbstractTest {
    @Deployment
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                .withTestClassPackage(AutoCloseSyntheticBeanTest.class)
    ...
    public void testWithAutoClose() {
        ...
        assertFalse(WithAutoCloseDisposer.disposed);
        assertFalse(instance.closed);
        bean.destroy(instance, cc);
        assertTrue(WithAutoCloseDisposer.disposed);
    ...
    public void testWithoutAutoClose() {
        ...
        assertFalse(WithoutAutoCloseDisposer.disposed);
        bean.destroy(instance, cc);
        assertTrue(WithoutAutoCloseDisposer.disposed);
    }
