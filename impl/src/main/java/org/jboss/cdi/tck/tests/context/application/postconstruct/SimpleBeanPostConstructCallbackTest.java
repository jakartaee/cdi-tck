...
public class SimpleBeanPostConstructCallbackTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(SimpleBeanPostConstructCallbackTest.class)
                .withClasses(SimpleBean.class, Service.class, Action.class).build();
    }

    @Test(dataProvider = ARQUILLIAN_DATA_PROVIDER)
    @SpecAssertions({ @SpecAssertion(section = "6.7.3", id = "h") })
