...
public class TooManyScopesTest extends AbstractTest {
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder().withTestClass(TooManyScopesTest.class).withClass(BeanWithTooManyScopeTypes_Broken.class)
                .build();
    }

    @Test
    @SpecAssertions({ @SpecAssertion(section = DECLARING_BEAN_SCOPE, id = "ba"),
