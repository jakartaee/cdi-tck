...
public class DependentBeanFinalMethodInterceptorTest extends AbstractTest {

    @Inject
    NuclearMissileFinalMethod nuclearMissileFinalMethod;
    ...
    public static WebArchive createTestArchive() {
        return new WebArchiveBuilder()
                ...
                .withClasses(FooBinding.class, MissileInterceptor.class, NuclearMissileFinalMethod.class)
                .withBeansXml(
