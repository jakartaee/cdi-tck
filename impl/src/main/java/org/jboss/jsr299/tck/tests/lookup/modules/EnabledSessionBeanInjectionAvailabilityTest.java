...
public class EnabledSessionBeanInjectionAvailabilityTest extends AbstractJSR299Test {
    ...
    @SpecAssertions({ @SpecAssertion(section = "5.1.4", id = "d"), @SpecAssertion(section = "5.1", id = "aa") })
