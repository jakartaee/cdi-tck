...
This profile uses link:$$https://github.com/tremes/arquillian-container-se$$[Arquillian container SE] which enables you to run SE tests in a separate JVM instance with isolated configurable classpath.
