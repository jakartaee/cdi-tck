...
*  *Testing platform* - The CDI TCK requires version 1.7.0.Alpha2 of the Arquillian (http://arquillian.org). The TCK test suite is based on TestNG 6.x (http://testng.org). .
