...
Please note that this exclude list serves only for the previous micro version of TCK release! This means that if the latest version of TCK is e.g. 3.0.1 then this exclude list is valid only for the version 3.0.0 and invalid for any other version!
