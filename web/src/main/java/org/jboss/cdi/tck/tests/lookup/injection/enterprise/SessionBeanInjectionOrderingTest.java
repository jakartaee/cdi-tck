...
public class SessionBeanInjectionOrderingTest extends AbstractTest {
    ...
    @Test
    @SpecAssertions({ @SpecAssertion(section = FIELDS_INITIALIZER_METHODS_EE, id = "bc"),
            @SpecAssertion(section = FIELDS_INITIALIZER_METHODS_EE, id = "bd") })
