 ...
 */
@Dependent
public class SenderAccountTransactionObserver extends AbstractObserver {
     ...
     * @throws Exception
     */
    public void withdrawBeforeCompletion(@Observes(during = TransactionPhase.BEFORE_COMPLETION) TxWithdrawal txWithdrawal)
            throws Exception {
